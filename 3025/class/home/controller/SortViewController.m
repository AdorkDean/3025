...
@interface SortViewController () <UITableViewDataSource, UITableViewDelegate, UISearchBarDelegate, UIPickerViewDataSource, UIPickerViewDelegate, SortCellDelegate> {
...
- (void)setupUI {
    ...
    searchBar.placeholder = @"输入用户ID精确查找";
...
- (void)sort:(UIButton *)button {
    ...
    if (userid.length > 0) {
        ...
        [[NSUserDefaults standardUserDefaults] setObject:userid forKey:kSortUserid];
